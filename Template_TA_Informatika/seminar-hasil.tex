...
\documentclass[dvipsnames]{jifhasiltheme}
...
% mengatur format pada daftar lampiran
\renewcommand{\cftappendicespresnum}{Lampiran\ }
\cftsetindents{appendices}{1em}{5.3em}
...
\approvalpage
% \clearpage\addcontentsline{toc}{chapter}{Halaman Pengesahan}
% \includepdf[pages={1}]{pengesahan-hasil.pdf}
